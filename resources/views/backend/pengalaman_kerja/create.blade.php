                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ isset($pengalaman_kerja) ? route('pengalaman_kerja.update',
                            $pengalaman_kerja->id) : route('pengalaman_kerja.store') }}"
                            id="pengalaman_kerja_form" method="POST">
                                {!! csrf_field() !!}
                                ...
                                @endif
                                <div class="col-12">
                                    <label for="cname" class="form-label">Nama Perusahaan
                                ...
                                <div class="col-12">
                                    <label for="cname" class="form-label">Jabatan
                                        <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="jabatana" name="jabatana" minlength="2"
                                    value="{{ isset($pengalaman_kerja) ? $pengalaman_kerja->jabatana : '' }}" required>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="inputAddress" class="form-label">Tahun Selesai
                                        <span class="required">*</span></label>
